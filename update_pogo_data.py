...
def AddMove(gm_obj, is_fast):
    ...
    move_obj["power"] = gm_obj_s.get("power", 0)
    move_obj["duration"] = gm_obj_s["durationMs"]
    move_obj["damage_window_start"] = gm_obj_s.get("damageWindowStartMs", 0)
    move_obj["damage_window_end"] = gm_obj_s["damageWindowEndMs"]
    move_obj["energy_delta"] = gm_obj_s.get("energyDelta", 0)
